...
const Footer = () => {
    return (
        <div>
            <footer className="footer mt-20 p-10 bg-base-300 text-base-content flex flex-col md:flex-row justify-around">
                <div className='w-60'>
                ...
                <div className='w-60'>
                    ...
                    <p className="flex flex-row items-center gap-2"><FaPhoneAlt /> (612) 796-4582</p>
                    <p className="flex flex-row items-center gap-2"><MdEmail /> info@artnest.com</p>
